...
## 2024-05-15 - Fast simple char search
...
**Action:** When searching for multiple simple ASCII bytes in hot paths, prefer `.as_bytes().iter().any(...)` over `.contains([char_array])`.
