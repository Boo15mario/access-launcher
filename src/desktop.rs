...
// Optimization: Uses BTreeMap<&'static str, Vec<usize>> to eliminate String allocations
// during insertion. map_categories returns static string slices, so we can store them
// directly, saving a heap allocation per category group per launch.
